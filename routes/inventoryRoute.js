...
const classificationValidation = require("../utilities/inventory-validation");
...
router.post("/add-classification", classificationValidation.validateClassification, invController.addClassification);
